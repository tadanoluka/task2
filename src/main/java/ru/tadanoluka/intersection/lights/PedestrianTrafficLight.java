...
public class PedestrianTrafficLight extends TrafficLight {
    private static final TrafficLightType TRAFFIC_LIGHT_TYPE = TrafficLightType.PEDESTRIAN;

    public PedestrianTrafficLight(Intersection intersection, boolean isLeader, TrafficGroup trafficGroup) {
